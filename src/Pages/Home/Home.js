...
export default function Home() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
      ...
      <div className="mb-8">
        <h1 className="text-gray-900 text-lg font-medium">Touristic Sites in Cameroon</h1>
        ...
        <h1 className="text-gray-900 text-lg font-medium">Heritage Sites</h1>
      ...
      <div className="grid grid-cols-4 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 xl:gap-x-8">
